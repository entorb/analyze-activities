...
2. run [git_2_analyze.py](src/git_2_analyze.py) to convert into  `output/git.json`
...
2. run [oura.py](src/oura.py) to convert into `output/oura.json`
...
1. run [join.py](src/join.py) to generate `output/join.json`
